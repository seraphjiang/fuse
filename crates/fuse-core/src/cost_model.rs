...
pub fn scan_cost(estimated_rows: u64, columns: usize) -> CostEstimate {
    ...
    CostEstimate { estimated_rows, estimated_cost: io + cpu, io_cost: io, cpu_cost: cpu }
}
...
pub fn sort_cost(rows: u64) -> CostEstimate {
    ...
    CostEstimate { estimated_rows: rows, estimated_cost: cost, io_cost: 0.0, cpu_cost: cost }
}
...
pub fn total_cost(estimates: &[CostEstimate]) -> CostEstimate {
    ...
    CostEstimate { estimated_rows: rows, estimated_cost: cost, io_cost: io, cpu_cost: cpu }
}
